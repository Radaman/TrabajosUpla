...
import VentasRepuestos.Repuesto;
import VentasRepuestos.Validador;
...
public class Login extends javax.swing.JFrame {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(PF_contraseña, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
    ...
    private void BTN_entrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_entrarActionPerformed
         String contraseña = new String(PF_contraseña.getPassword());
        Validador validador = new Validador();
        
        if(validador.ValidarUsuarioClave(TF_usuario.getText(), contraseña))
        {
         JOptionPane.showMessageDialog(null, "Usuario Ingresado Correctamente", contraseña, HEIGHT);
         List<Repuesto> listaRepuesto = new ArrayList<>();
         this.setVisible(false);
         Bienvenida Negocio = new Bienvenida();
         Negocio.setVisible(true);
         
        }
        else
        {
         JOptionPane.showMessageDialog(null, "Usuario / Contraseña Incorrectos", contraseña, HEIGHT);
        }
